...
public section.
  ...
  types:
    begin of TS_ZFI_UPDATE_STATUS,
        ...
        SALESORDERID type /IWBEP/SB_ODATA_TY_INT2,
...
TT_SOITEM type standard table of TS_SOITEM .
  types:
  begin of TS_SOMESSAGE,
     PRIMARYKEY type C length 10,
  ...
  types:
TT_SOMESSAGE type standard table of TS_SOMESSAGE .
  ...
  constants GC_SOMESSAGE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SOMessage' ##NO_TEXT.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251021165847'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'PrimaryKey'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SOMessage'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
lo_action->set_return_entity_type( 'SOMessage' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZSO_MANAGE_MPC=>TS_ZFI_UPDATE_STATUS' ). "#EC NOTEXT
  endmethod.


  method DEFINE_SOMESSAGE.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SOMessage' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'PrimaryKey' iv_abap_fieldname = 'PRIMARYKEY' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSO_MANAGE_MPC=>TS_SOMESSAGE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SOMessageSet' ). "#EC NOTEXT
