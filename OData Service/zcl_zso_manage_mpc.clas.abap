class ZCL_ZSO_MANAGE_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSO_MANAGE_MPC============CP' ##NO_TEXT.
...
CLASS ZCL_ZSO_MANAGE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSO_MANAGE_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSOHEADER'
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSOITEM'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SOItem'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
